...
public class PerfilServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Usuario.Tipo tipo = usuarioLogado.getTipo();

            request.setAttribute("usuarioLogado", usuarioLogado);

            if (tipo == Usuario.Tipo.COMUM || tipo == Usuario.Tipo.ESTUDANTE) {
                // ✅ Só calcula para COMUM e ESTUDANTE
                ...
                // ✅ Admin e Bibliotecário — layout do painel admin
                request.getRequestDispatcher("/perfil_admin.jsp")
                        .forward(request, response);
            }
