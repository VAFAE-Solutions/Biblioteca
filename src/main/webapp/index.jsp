...
<%-- Única adição necessária para a lógica funcionar --%>
...
<header class="main-header">
    <div class="header-top">
        ...
        <div class="search-box">
            <form action="home" method="get" class="search-wrapper">
...
<main class="home-wrapper">
    ...
    <%-- SEÇÃO DE RESULTADOS: Só aparece se o usuário pesquisar algo --%>
    <c:if test="${not empty termoPesquisado}">
        <div class="highlights-container">
            <h2>Resultados para: "${termoPesquisado}"</h2>
            <div class="books-grid">
                <c:forEach var="livro" items="${livros}">
                    <a href="login.jsp" class="book-card">
            ...
            <c:if test="${empty livros}">
                <p style="padding: 20px;">Nenhum livro encontrado no banco.</p>
            </c:if>
            <hr> <%-- Linha divisória entre a busca e o seu design original --%>
        </div>
    </c:if>
