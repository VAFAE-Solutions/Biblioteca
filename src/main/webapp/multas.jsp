...
<div class="content">
    <div class="table-container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="fw-bold text-primary">💰 Minhas Multas</h2>
        ...
        <c:if test="${totalMulta > 0}">
            <div class="alert alert-danger d-flex justify-content-between
                ...
                <div>
                    ...
                    <span>Quite suas multas para realizar novos empréstimos.</span>
                </div>
                <div class="text-end">
        ...
        <table class="table table-hover">
            ...
            <c:forEach var="multa" items="${multas}">
                <tr class="${multa.pago ? '' : 'table-danger'}">
                    <%-- ✅ Título do livro --%>
                    <td>
                        <strong>${multa.emprestimo.exemplar.livro.titulo}</strong>
                    </td>
                    <td>${multa.dataGeracao}</td>
                    <td>
                        R$ <fmt:formatNumber value="${multa.valor}"
                            minFractionDigits="2" maxFractionDigits="2"/>
                    </td>
                    <td>
                        <c:choose>
