...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <a href="${pageContext.request.contextPath}/admin/usuarios-unidade" class="btn btn-outline-secondary">← Voltar</a>
            </c:otherwise>
        </c:choose>
    </div>
        ...
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/admin/cadastrar-usuario"
                ...
                <div class="mb-3">
                    ...
                    <select name="tipo" class="form-select" id="tipoSelect" required onchange="mostrarCampos()">
                ...
                <div class="d-flex gap-2">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <a href="${pageContext.request.contextPath}/admin/usuarios-unidade" class="btn btn-outline-secondary">Cancelar</a>
                        </c:otherwise>
                    </c:choose>
                </div>
            </form>
...
<script>
    ...
    function mostrarCampos() {
        ...
        document.getElementById('campoRa').style.display = tipo === 'ESTUDANTE' ? 'block' : 'none';
    }
</script>
</body>
</html>
