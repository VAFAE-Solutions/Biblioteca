...
<div class="topbar">
    ...
    <div>
        <a href="${pageContext.request.contextPath}/login"
           class="btn btn-outline-light btn-sm me-2">Entrar</a>
        <a href="${pageContext.request.contextPath}/cadastro"
           class="btn btn-light btn-sm">Cadastrar-se</a>
    </div>
</div>

<div class="sidebar">
    <a href="${pageContext.request.contextPath}/buscar?txtBusca=${termoPesquisado}&filtro=${filtro}"
       class="active">🔎 Catálogo</a>
