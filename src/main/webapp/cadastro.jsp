...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: Arial, sans-serif; }
        ...
        .container { width: 100%; min-height: 100vh; display: flex; justify-content: center; align-items: center; padding: 40px; }
        .cadastro-card { width: 100%; max-width: 550px; background: #fff; padding: 40px; border-radius: 14px; box-shadow: 0 0 20px rgba(0,0,0,0.1); }
        .cadastro-card h2 { text-align: center; margin-bottom: 10px; font-size: 34px; color: #222; }
        ...
        .form-group input:focus { outline: none; border: 1px solid #39c3cf; }
        .senha-wrapper { position: relative; display: flex; align-items: center; }
        .senha-wrapper input { width: 100%; padding-right: 45px; }
        ...
        .btn-cadastro { width: 100%; padding: 15px; border: none; background: #39c3cf; color: #fff; font-size: 18px; border-radius: 8px; cursor: pointer; transition: 0.3s; }
