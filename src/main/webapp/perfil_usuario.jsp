    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card p-3 shadow-sm text-center" style="border-left: 5px solid #40c4d4;">
                ...
                <a href="${pageContext.request.contextPath}/meus-emprestimos" class="btn btn-sm btn-outline-info mt-2">Ver</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 shadow-sm text-center" style="border-left: 5px solid #dc3545;">
                ...
                <a href="${pageContext.request.contextPath}/multas" class="btn btn-sm btn-outline-danger mt-2">Ver</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card p-3 shadow-sm text-center" style="border-left: 5px solid #ffc107;">
                ...
                <a href="${pageContext.request.contextPath}/minhas-reservas" class="btn btn-sm btn-outline-warning mt-2">Ver</a>
            </div>
        </div>
    </div>
